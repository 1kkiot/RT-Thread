...
#define W25Q128FV_SECTOR_ERASE_MAX_TIME       30000
#define W25Q128FV_SUBSECTOR_ERASE_MAX_TIME    8000
...
#define W25Qx_Enable() 			HAL_GPIO_WritePin(SPI_CS_GPIO_Port, SPI_CS_Pin, GPIO_PIN_RESET)
#define W25Qx_Disable() 		HAL_GPIO_WritePin(SPI_CS_GPIO_Port, SPI_CS_Pin, GPIO_PIN_SET)
